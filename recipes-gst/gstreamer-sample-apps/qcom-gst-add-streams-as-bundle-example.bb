...
FILESPATH =+ "${WORKSPACE}/:"
SRC_URI = "file://gst-plugins-qti-oss/gst-sample-apps/gst-add-streams-as-bundle-example"
S = "${WORKDIR}/gst-plugins-qti-oss/gst-sample-apps/gst-add-streams-as-bundle-example"
