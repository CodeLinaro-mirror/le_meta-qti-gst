...
FILESPATH =+ "${WORKSPACE}/:"
SRC_URI = "file://gst-plugins-qti-oss/gst-sample-apps/gst-videocodec-concurrent-playback"
S = "${WORKDIR}/gst-plugins-qti-oss/gst-sample-apps/gst-videocodec-concurrent-playback"
