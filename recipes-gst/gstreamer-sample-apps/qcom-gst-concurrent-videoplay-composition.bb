...
FILESPATH =+ "${WORKSPACE}/:"
SRC_URI = "file://gst-plugins-qti-oss/gst-sample-apps/gst-concurrent-videoplay-composition"
S = "${WORKDIR}/gst-plugins-qti-oss/gst-sample-apps/gst-concurrent-videoplay-composition"
