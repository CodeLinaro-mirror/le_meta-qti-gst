...
FILESPATH =+ "${WORKSPACE}/:"
SRC_URI = "file://gst-plugins-qti-oss/gst-sample-apps/gst-add-remove-streams-runtime"
S = "${WORKDIR}/gst-plugins-qti-oss/gst-sample-apps/gst-add-remove-streams-runtime"
