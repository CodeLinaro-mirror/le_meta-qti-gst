...
FILESPATH =+ "${WORKSPACE}/:"
SRC_URI = "file://gst-plugins-qti-oss/gst-sample-apps/gst-ai-multistream-batch-inference"
S = "${WORKDIR}/gst-plugins-qti-oss/gst-sample-apps/gst-ai-multistream-batch-inference"
