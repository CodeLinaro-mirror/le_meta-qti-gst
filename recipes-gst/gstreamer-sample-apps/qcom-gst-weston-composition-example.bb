...
FILESPATH =+ "${WORKSPACE}/:"
SRC_URI = "file://gst-plugins-qti-oss/gst-sample-apps/gst-weston-composition-example"
S = "${WORKDIR}/gst-plugins-qti-oss/gst-sample-apps/gst-weston-composition-example"
