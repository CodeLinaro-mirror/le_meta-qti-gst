...
RDEPENDS:packagegroup-qti-gst = " \
      ...
      gstreamer1.0-plugins-qti-oss-sensorsrc \
      ...
      ${@bb.utils.contains("BASEMACHINE", "kalama", "gstreamer1.0-plugins-qti-oss-drmdecryptor", "", d)} \
...
RDEPENDS:packagegroup-qti-gst:remove:qcm2290-mtp = " \
      gstd \
      gstreamer1.0-plugins-qti-oss-cv-optclflow \
    "
