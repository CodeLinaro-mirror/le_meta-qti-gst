...
SUMMARY = "QTI open-source GStreamer Plug-in for packing MIPI RAW image into DNG with Jpeg Thumbnail"
SECTION = "multimedia"
...
SRC_URI = "file://gst-plugin-dngpacker/"
S = "${WORKDIR}/gst-plugin-dngpacker"
