...
SUMMARY = "QTI open-source GStreamer Plug-in for Hexagon SDK functions"
SECTION = "multimedia"
...
SRC_URI = "file://gst-plugin-hexagon/"
S = "${WORKDIR}/gst-plugin-hexagon"
...
FILES:${PN}-dbg += "${INSTALL_LIBDIR}/gstreamer-1.0/hexagon/modules/.debug"
