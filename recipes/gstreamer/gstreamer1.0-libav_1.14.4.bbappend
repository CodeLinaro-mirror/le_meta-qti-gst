...
LIBAV_EXTRA_CONFIGURE_COMMON_ARG_append_qcs405-som1 = "${CONFIGURE_PLUGINS_LIBAV}"
LIBAV_EXTRA_CONFIGURE_COMMON_ARG_append_qcs403-som2 = "${CONFIGURE_PLUGINS_LIBAV}"
